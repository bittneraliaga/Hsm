...
<head>
  ...
  <title>Importar datos de fenologia</title>
...
<h3 class="text-center">
    Importar datos de fenologia de Excel
</h3>
<hr>
<br><br>
 <div class="row">
    <div class="col-md-12">
      <form action="masiva_fenologia.php" method="POST" enctype="multipart/form-data">
  ...
  $sqlFenologia = ("SELECT * FROM fenologia ORDER BY estado_fenol ASC");
  $queryData   = mysqli_query($conexion, $sqlFenologia);
  $total_client = mysqli_num_rows($queryData);
  ?>
      <h6 class="text-center">
        Lista de Fenologias <strong>(<?php echo $total_client; ?>)</strong>
      </h6>
        ...
        <table class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo $data['estado_fenol']; ?></td>
