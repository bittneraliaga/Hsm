...
foreach ($lineas as $linea) {
    ...
    if( !empty($codigo) ){
        $checkemail_duplicidad = ("SELECT codigo FROM implemento WHERE codigo='".($codigo)."' ");
    ...
    if ( $cant_duplicidad == 0 ) { 
        ...
        $insertarData = "INSERT INTO implemento (codigo, descripcion) 
...
/**Caso Contrario actualizo el o los Registros ya existentes*/
    ...
    $updateData =  ("UPDATE implemento SET 
        codigo='" .$codigo. "',
...
<a href="index_implemento.php">Atras</a>