...
<head>
  ...
  <title>Importar datos de implementos</title>
...
<h3 class="text-center">
    Importar datos de implementos de Excel
</h3>
<hr>
<br><br>
 <div class="row">
    <div class="col-md-12">
      <form action="masiva_implemento.php" method="POST" enctype="multipart/form-data">
  ...
  $sqlImplemento = ("SELECT * FROM implemento ORDER BY codigo ASC");
  $queryData   = mysqli_query($conexion, $sqlImplemento);
  $total_client = mysqli_num_rows($queryData);
  ?>
      <h6 class="text-center">
        Lista de Implementos <strong>(<?php echo $total_client; ?>)</strong>
      </h6>
